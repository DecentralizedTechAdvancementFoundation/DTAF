...
*   **xz 백도어 사건:** xz 유틸리티(데이터 압축 프로그램)에서 발견된 백도어(악성 코드) 사건입니다. 오픈소스 프로젝트의 보안 취약점을 보여주는 대표적인 사례입니다. [xz 백도어 사건 - Schneier on Security](https://ko.wikipedia.org/wiki/XZ_Utils_%EB%B0%B1%EB%8F%84%EC%96%B4)
